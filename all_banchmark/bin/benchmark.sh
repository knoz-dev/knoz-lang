...
PROGRAMS=(
  ackermann_knoz ackermann_c ackermann_cpp ackermann_rust 
  collatz_knoz collatz_c collatz_cpp collatz_rust 
  fibonacci_knoz fibonacci_c fibonacci_cpp fibonacci_rust 
  sum_squares_knoz sum_squares_c sum_squares_cpp sum_squares_rust 
)
